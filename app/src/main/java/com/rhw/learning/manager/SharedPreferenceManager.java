...
public class SharedPreferenceManager {
     ...
     * Preference文件名
     */
    private static final String SHARE_PREFREENCE_NAME = "rhw.pre";
    ...
    private SharedPreferenceManager() {
        sp = LearningApplication.getInstance().getSharedPreferences(SHARE_PREFREENCE_NAME, Context.MODE_PRIVATE);
        editor = sp.edit();
    }
